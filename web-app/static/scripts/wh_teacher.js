...
function wait_hall_t(){
    ajax(`http://51.250.99.184:8080/games/${code}`, "GET", response_reg, dataArr)
    ...
    $("#start_quiz").click(function(event){
        ajax(`http://51.250.99.184:8080/games/${code}/state`, "PUT", response_reg, JSON.stringify(dataArr2));
