...
function wait_hall_t(){
    ajax(`https://b1f9-188-130-155-167.ngrok.io/games/${code}`, "GET", response_reg, dataArr)
    ...
    $("#start_quiz").click(function(event){
        ajax(`https://b1f9-188-130-155-167.ngrok.io/games/${code}/state`, "PUT", response_reg, JSON.stringify(dataArr2));
