...
//    ajax(`https://23aa-188-130-155-167.ngrok.io:8080/games/${code}`, "GET", game_procces)
    ...
    let timerId = setInterval(() => ajax(`http://51.250.19.225:8080/games/${code}`, "GET", response_reg), 500);
    ...
    function response_reg(dataArray){
        ...
        if (changes != changes2 && JSON.parse(dataArray).type != "Finished"){
            ...
            if (changes2 != 0){
                ...
                ajax(`http://51.250.19.225:8080/games/${code}`, "PUT", response_reg, JSON.stringify(data_json));
